...
st.markdown(
    ":gray-badge[05z and above] :gray-badge[better on desktop] :gray-badge[adapted from [@celdaris](https://x.com/celdaris)] :blue-badge[none will eliminate ALL three pairings]"""
)
